...
function initShortQuestion() {
 qstHead[0]="2 Complete the box. Use short forms   example  i 'm";
 qstHead[1]="3  Write two sentences with the verb be, one affirmative and one negative. ...";
 qstHead[2]="4 Complete the questions with the correct form of the verb be.";
 qstHead[3]="5  Complete the box. Use short forms.  What are the long forms?  Have got";
 qstHead[4]="6 Complete the sentences with the correct form of have got, affirmative or ...";
 qstHead[5]="7  Listen. Choose the things that Joe an Amy have got ";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,4,4,4,4);
