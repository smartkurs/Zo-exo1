...
function initShortQuestion() {
 qstHead[0]="1  Put the words in the correct order to make questions.  ";
 qstHead[1]="Write the names of the people and the  countries they are from. example 1 Viktoria is from Hungary.  ";
 qstHead[2]="listen and write the letters and numbers. ";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,4);
