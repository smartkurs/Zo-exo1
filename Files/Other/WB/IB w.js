...
function initShortQuestion() {
 qstHead[0]="1 Write af?rmative or negative sentences with the correct form of the verb be. example 1 they.cousins  Negative  They aren't cousine. ";
 qstHead[1]="Put the words in the correct order to make questions. Then write short answers.  example 1 seventeen . are .you Are you seventeen? No  I’m not Negative ";
 qstHead[2]="Write true sentences. Uses the affirmative or negative form of have got. example 1 I have go,haven’t got a bike                      or I haven’t got a bike  ";
 qstHead[3]="Look at the table. Write questions and short answers with the correct form of have got.    example 1 Liam .a skateboard? Has Liam got a skateboard? Yes he has  ";
 qstHead[4]="Complete the email to a penfriend. Use be and have got, affirmative, negative and interrogative. ";
}
